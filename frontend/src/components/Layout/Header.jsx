        ...
        <header className="h-20 px-8 flex items-center justify-between bg-surface/50 backdrop-blur-xl border-b border-border sticky top-0 z-20">
            <div className="flex items-center gap-4 flex-1">
                <div className="relative w-96 group">
                    ...
                    <input
                        type="text"
                        placeholder="Search projects, analysis, or bugs..."
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3">
                    <div className="text-right hidden md:block">
                        <p className="text-sm font-bold text-white">{user?.full_name || user?.username || 'Guest User'}</p>
                        <p className="text-xs text-text-secondary font-medium">{user?.is_guest ? 'Guest Access' : 'Pro Member'}</p>
                    </div>
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary via-primary/80 to-indigo-600 flex items-center justify-center shadow-lg shadow-primary/20 border border-white/10">
